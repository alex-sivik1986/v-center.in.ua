...
class ControllerCatalogCategory extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (isset($this->request->post['image_home'])) {
			...
			$data['image_home'] = $category_info['image_home'];
		} else {
			$data['image_home'] = '';
		}
		...
		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['image_home'])) {
			$data['thumb_home'] = $this->model_tool_image->resize($category_info['image_home'], 100, 100);
		} else {
