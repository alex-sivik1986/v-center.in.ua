...
class ControllerCatalogInformation extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
        ...
        $data['text_chart_heading_1'] = $this->language->get('text_chart_heading_1');
        $data['text_chart_heading_2'] = $this->language->get('text_chart_heading_2');
        $data['text_chart_heading_3'] = $this->language->get('text_chart_heading_3');
        $data['text_chart_heading_4'] = $this->language->get('text_chart_heading_4');
        $data['text_chart_heading_5'] = $this->language->get('text_chart_heading_5');
        $data['text_chart_heading_6'] = $this->language->get('text_chart_heading_6');
        $data['text_chart_heading_7'] = $this->language->get('text_chart_heading_7');
        $data['text_size_data'] = $this->language->get('text_size_data');
        $data['text_new_row'] = $this->language->get('text_new_row');
		...
		$data['chart_data'] = $this->model_catalog_information->edit($this->request->get['information_id']);
        $data['chart_headings'] = unserialize($data['chart_data']['chart_headings']);
		
		$data['chart_name'] = unserialize($data['chart_data']['chart_name']);
		
        $data['size_data'] = unserialize($data['chart_data']['size_data']);
	   }
		if (isset($this->error['warning'])) {
			$data['error_warning'] = $this->error['warning'];
		} else {
