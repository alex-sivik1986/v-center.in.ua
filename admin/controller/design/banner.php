...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['theme'])) {
			...
			$data['theme'] = $banner_info['theme'];
		} else {
			$data['theme'] = true;
		}
		$data['theme_count'] = array('default'=>'Стандартный', 'benefits'=>'Преимущества', 'partners'=>'Партнёры','reviews'=>'Отзывы','home_slider'=>'Плашки на главной');
