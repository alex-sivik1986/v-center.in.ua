...
class ControllerLocalisationLocation extends Controller {
	...
	protected function getForm() {
      ...
      foreach ($this->model_localisation_language->getLanguageId() as $lang) {
		...
		if (isset($this->request->post['name'][$lang['language_id']])) {
			$data['name'][$lang['language_id']] = $this->request->post['name'][$lang['language_id']];
		} elseif (!empty($location_info)) { 
			$data['name'][$lang['language_id']] = $location_info[$lang['language_id']]['name'];
		} else {
			$data['name'][$lang['language_id']] =   '';
		}

		if (isset($this->request->post['address'][$lang['language_id']])) {
			$data['address'][$lang['language_id']] = $this->request->post['address'][$lang['language_id']];
		} elseif (!empty($location_info)) {
			$data['address'][$lang['language_id']] = $location_info[$lang['language_id']]['address'];
		} else {
			$data['address'][$lang['language_id']] = '';
		}

		if (isset($this->request->post['geocode'][$lang['language_id']])) {
			$data['geocode'][$lang['language_id']] = $this->request->post['geocode'][$lang['language_id']];
		} elseif (!empty($location_info)) {
			$data['geocode'][$lang['language_id']] = $location_info[$lang['language_id']]['geocode'];
		} else {
			$data['geocode'][$lang['language_id']] = '';
		}

		if (isset($this->request->post['telephone'][$lang['language_id']])) {
			$data['telephone'][$lang['language_id']] = $this->request->post['telephone'][$lang['language_id']];
		} elseif (!empty($location_info)) {
			$data['telephone'][$lang['language_id']] = $location_info[$lang['language_id']]['telephone'];
		} else {
			$data['telephone'][$lang['language_id']] = '';
		}

		if (isset($this->request->post['fax'][$lang['language_id']])) {
			$data['fax'] = $this->request->post['fax'][$lang['language_id']];
		} elseif (!empty($location_info)) {
			$data['fax'][$lang['language_id']] = $location_info[$lang['language_id']]['fax'];
		} else {
			$data['fax'][$lang['language_id']] = '';
		}

		if (isset($this->request->post['image'][$lang['language_id']])) {
			$data['image'][$lang['language_id']] = $this->request->post['image'];
		} elseif (!empty($location_info)) {
			$data['image'][$lang['language_id']] = $location_info[$lang['language_id']]['image'];
		} else {
			$data['image'][$lang['language_id']] = '';
		}

		$this->load->model('tool/image');

		if (isset($this->request->post['image'][$lang['language_id']]) && is_file(DIR_IMAGE . $this->request->post['image'][$lang['language_id']])) {
			$data['thumb'][$lang['language_id']] = $this->model_tool_image->resize($this->request->post['image'][$lang['language_id']], 100, 100);
		} elseif (!empty($location_info) && is_file(DIR_IMAGE . $location_info[$lang['language_id']]['image'])) {
			$data['thumb'][$lang['language_id']] = $this->model_tool_image->resize($location_info[$lang['language_id']]['image'], 100, 100);
		} else {
			$data['thumb'][$lang['language_id']] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

		$data['placeholder'] = $this->model_tool_image->resize('no_image.png', 100, 100);

		if (isset($this->request->post['open'][$lang['language_id']])) {
			$data['open'][$lang['language_id']] = $this->request->post['open'][$lang['language_id']];
		} elseif (!empty($location_info)) {
			$data['open'][$lang['language_id']] = $location_info[$lang['language_id']]['open'];
		} else {
			$data['open'][$lang['language_id']] = '';
		}

		if (isset($this->request->post['comment'][$lang['language_id']])) {
			$data['comment'][$lang['language_id']] = $this->request->post['comment'][$lang['language_id']];
		} elseif (!empty($location_info)) {
			$data['comment'][$lang['language_id']] = $location_info[$lang['language_id']]['comment'];
		} else {
			$data['comment'][$lang['language_id']] = '';
		}
}
...
/*foreach ($this->request->post['address'] as $language_id => $value) {
		if ((utf8_strlen($value) < 3) || (utf8_strlen($value) > 128)) {
			$this->error['address'] = $this->language->get('error_address');
		}
}*/
foreach ($this->request->post['telephone'] as $language_id => $value) {
