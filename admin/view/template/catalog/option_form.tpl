            ...
            <tbody>
              ...
              <tr id="option-value-row<?php echo $option_value_row; ?>">
                <td class="text-left"><input type="hidden" name="option_value[<?php echo $option_value_row; ?>][option_value_id]" value="<?php echo $option_value['option_value_id']; ?>" />
                  ...
                  <?php } ?>
                  <?php } ?>
				  <input type="text" name="option_value[<?php echo $option_value_row; ?>][long_name]" value="<?php echo $option_value['long_name']; ?>" placeholder="<?php echo $entry_option_value; ?>" class="form-control" />
                ...
                <a href="" id="thumb-image<?php echo $option_value_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $option_value['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
				  ...
				  <span>
				<a href="" id="image<?php echo $option_value_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $option_value['thumb2']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="option_value[<?php echo $option_value_row; ?>][image2]" value="<?php echo $option_value['image2']; ?>" id="th-image<?php echo $option_value_row; ?>" /></td>
				  </span>
...
function addOptionValue() {
    ...
    html += '    </div>';
	<?php } ?>
	html += '  <input type="text" name="option_value[' + option_value_row + '][long_name]" value="" placeholder="<?php echo $entry_option_value; ?>" class="form-control" />';
	html += '</td>';
    html += '  <td class="text-left"><span><a href="" id="thumb-image' + option_value_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="option_value[' + option_value_row + '][image]" value="" id="input-image' + option_value_row + '" /></span>';
	html += '  <span><a href="" id="image' + option_value_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="option_value[' + option_value_row + '][image2]" value="" id="image-th' + option_value_row + '" /></span></td>';
