      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_status; ?></label>
            <div class="col-sm-10">
              <select name="theme" id="input-status" class="form-control">
			  <? foreach($theme_count as $key=>$th) {  ?>
			  <?php if ($theme==$key) { ?>
			     <option value="<?=$key?>" selected="selected"><?=$th?></option>
          ...
          <div class="tab-content">
			...
			<label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>"></label>
                      ...
                      <textarea name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][description]" data-lang="<?php echo $lang; ?>"  id="input-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo  $banner_image['description']; ?></textarea>
                   </label>
                      ...
                      <?php } ?></td>
                    <td class="text-left" style="width: 30%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][link]" value="<?php echo $banner_image['link']; ?>" placeholder="<?php echo $entry_link; ?>" class="form-control" /><label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>"></label>
					<textarea style="width: 100%;" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][video]" placeholder="iframe youtube" ><?php echo $banner_image['video']; ?></textarea>
					</td>
...
function addImage(language_id) {
    ...
    html += '  <td class="text-left"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][title]" value="" placeholder="<?php echo $entry_title; ?>" class="form-control" /><label class="col-sm-2 control-label" for="input-description'+language_id +'"></label><textarea name="banner_image['+ language_id +'][<?php echo $image_row; ?>][description]" data-lang="<?php echo $lang; ?>"  id="input-description'+ language_id +'" class="form-control summernote"></textarea></td>';	
	html += '  <td class="text-left" style="width: 30%;"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /><label class="col-sm-2 control-label" for="input-description'+language_id +'"></label><textarea name="banner_image['+ language_id +'][<?php echo $image_row; ?>][video]" data-lang="<?php echo $lang; ?>" placeholder="iframe youtube"  id="input-video'+ language_id +'" class="form-control summernote"></textarea></td>';	
