                ...
                <form class="form-horizontal">
                    ...
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                                    ...
                                    <?php if ($order_products || $order_vouchers) { ?>
                                        ...
                                        <?php foreach ($order_products as $order_product) { ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <input type="hidden" name="product[<?php echo $product_row; ?>][price_m]" value="<?php echo $order_product['price_m']; ?>" />
                                                </td>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab-product">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="input-quantity"><?php echo 'м2';//$entry_quantity; ?></label>
                                            <div class="col-sm-10">
                        ...
                        <div class="tab-pane" id="tab-payment">
                            ...
                            <!--<div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-payment-city"><?php echo 'Отделение';//$entry_city; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-payment-country"><?php echo 'Регион / область';//$entry_country; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-payment-zone"><?php echo 'Населенный пункт';//$entry_zone; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-payment-city"><?php echo 'Отделение';//$entry_zone; ?></label>
                                <div class="col-sm-10">
                    ...
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                        ...
                        <div class="tab-pane" id="tab-shipping">
                            ...
                            <!--<div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-shipping-city"><?php echo 'Отделение';//$entry_city; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-shipping-country"><?php echo 'Регион / область';//$entry_country; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-shipping-zone"><?php echo 'Населенный пункт';//$entry_zone; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-shipping-city"><?php echo 'Отделение';//$entry_zone; ?></label>
                                <div class="col-sm-10">
    ...
    <script type="text/javascript"><!--
        ...
        $(document).delegate('.change_kol input', 'change', function() {
            ...
            $.ajax({
                ...
                type: 'post',
                data: node_input.closest('.table-responsive').find('input[name^=\'product\'][type=\'text\'], input[name^=\'product\'][type=\'hidden\'], input[name^=\'product\'][type=\'radio\']:checked, input[name^=\'product\'][type=\'checkbox\']:checked, select[name^=\'product\'], textarea[name^=\'product\']'),
                dataType: 'json',
                crossDomain: true,
                // beforeSend: function() {
                //     $(node).button('loading');
                ...
                success: function(json) {
                    ...
                    if (json['products'].length) {
                        for (i = 0; i < json['products'].length; i++) {
                            ...
                            // html += '  <td class="text-right">' + product['price_m'] + '</td>';
                ...
                success: function(json) {
                    ...
                    if (json['city'] != '') {
                        for (i = 0; i < json['city'].length; i++) {
                            ...
                            if (json['city'][i]['name'] == '<?php echo $payment_city; ?>') {
                                html += ' selected="selected"';
                            }
                ...
                success: function(json) {
                    ...
                    if (json['city'] != '') {
                        for (i = 0; i < json['city'].length; i++) {
                            ...
                            if (json['city'][i]['name'] == '<?php echo $shipping_city; ?>') {
                                html += ' selected="selected"';
                            }
