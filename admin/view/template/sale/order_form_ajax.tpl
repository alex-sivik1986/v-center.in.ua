...
<div id="filemanager" class="modal-dialog modal-lg">
    <div class="modal-content modal_normal_display">
                                                    ...
                                                    <?php foreach ($order_products as $order_product) { ?>
                                                        <tr>
                                                            <td class="text-left"><?php echo $order_product['name']; ?><br />
                                                                ...
                                                                <input class="is_present_input" type="hidden" name="product[<?php echo $product_row; ?>][is_present]" value="<?php echo $order_product['is_present']; ?>" />
...
<style>
     ...
     .modal_normal_display .modal .modal-content {
