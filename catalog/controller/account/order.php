...
class ControllerAccountOrder extends Controller { 
	public function index() {
        ...
        $data['photo_text']     = $this->language->get('photo_text');
		$data['name_text']     = $this->language->get('name_text');
		$data['color_text']     = $this->language->get('color_text');
		$data['width_text']     = $this->language->get('width_text');
		$data['coef_text']     = $this->language->get('coef_text');
		...
		$data['price_total'] = $this->language->get('price_total');
        ...
        $data['order_size'] = $this->language->get('order_size');
		$data['text_empty'] = $this->language->get('text_empty');
        $data['prod_total'] = $this->language->get('prod_total');
		 $data['products_quantity'] = $this->language->get('products_quantity');
		$data['prod_plat'] = $this->language->get('prod_plat');
		...
		foreach ($results as $result) {
			...
			foreach ($products as $key => $product) {
				...
				foreach ($options as $option) {
                    ...
                    $options_all = $this->model_account_order->getOrderOptions($option['product_option_id'], $option['product_option_value_id'], $product['product_id']);
               ...
               $attr = $this->model_account_order->getProductAttribute($product['product_id']); 
			...
			$data['orders'][] = array(
				...
				'summa'    => $quantity,
				'product_buy'=> $products,
				'date_added' => date($this->language->get('date_format_short'), strtotime($result['date_added'])),
				'time_added' => date($this->language->get('time_format_short'), strtotime($result['date_added'])),
