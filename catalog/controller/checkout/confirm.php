...
*/
		...
		if (!$redirect) {
			...
			$order_data['payment_country'] = $this->session->data['payment_method']['title'];
			} else {
			...
			if ($this->cart->hasShipping()) {
				...
				$order_data['shipping_country'] = $this->session->data['shipping_method']['title'];
				} else {
			...
			if (!empty($this->request->post['city'])) { 
				...
				$this->request->post['firstname'] = $this->request->post['firstname'];
			...
			} elseif(isset($this->request->post['address_id']) && !empty($this->request->post['address_id'])) { 
			$this->load->model('account/address');
			$adress = $this->model_account_address->getAddress($this->request->post['address_id']);
