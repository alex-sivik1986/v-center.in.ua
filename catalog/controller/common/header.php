...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['text_laboratoriya'] = $this->language->get('text_laboratoriya');
		$data['text_proizvodstvo'] = $this->language->get('text_proizvodstvo');
        ...
        $data['home_text'] = $this->language->get('home_text');
		 $data['news'] = $this->language->get('news');
		 $data['text_catalog_menu'] = $this->language->get('text_catalog_menu');
		...
		if ($this->customer->isLogged()) {
            ...
            if($this->model_account_wishlist->getTotalWishlist()>0) {
			...
			$data['text_wishlist'] = sprintf($this->language->get('text_wishlist'), (isset($this->session->data['wishlist']) ? count($this->session->data['wishlist']) : ''));
