...
class ControllerExtensionModuleViewed extends Controller {
	public function index($setting) {
        ...
        $data['haracter'] = $this->language->get('haracter');
		...
		foreach ($products as $product_id) {
			...
			if ($product_info) {
                ...
                $attr = $this->model_catalog_product->getProductAttribute($product_info['product_id']);
				$data['products'][] = array(
					'product_id'  => $product_info['product_id'],
					'short_description' => html_entity_decode($product_info['short_description']),
					'thumb'       => $image,
					'attribute'   => $attr,
