...
*/
        ...
        $data['your_review'] = $this->language->get('your_review');
    ...
    public function write()
    {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            $data['text_success'] = $this->language->get('text_success');
			 $data['error_mail'] = $this->language->get('error_mail');


            if ((utf8_strlen($this->request->post['name']) < 3) || (utf8_strlen($this->request->post['name']) > 25)) { echo $this->request->post['name'];
                $json['error'] = $data['error_name'];
            }
            if ((utf8_strlen($this->request->post['mail']) < 3) || filter_var($this->request->post['mail'], FILTER_VALIDATE_EMAIL)==false) {
                $json['error'] = $data['error_mail'];
            }
