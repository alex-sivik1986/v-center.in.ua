						  ...
						  <div class="tit">
                               ...
                               <ul><?php if (!$logged) { ?>
								...
								<li><a href="<?php echo $order; ?>" ><span><?php echo $text_order; ?></span></a></li>
								 <li><a href="<?php echo $password; ?>" class="active"><span><?php echo $text_password; ?></span></a></li>
								<?php if ($logged) { ?>
								<li><a href="<?php echo $logout; ?>"><span><?php echo $text_logout; ?></a></span></li>
								<?php } ?>
								</ul>
                            </div>
 <div class="personal-body fadeEl fadeEl-right start-anim personal-hist password_ac">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
		  ...
		  <div class="form-group">
              <input type="password" name="old-password" value="<?php echo $old_password; ?>" placeholder="<?php echo $entry_password_old; ?>" id="input-old-password" class="form-control" />
