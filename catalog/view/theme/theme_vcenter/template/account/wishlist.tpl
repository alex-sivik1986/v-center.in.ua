...
<div class="row">
							...
							<div class="tit">
                                ...
                                <span><?php echo $texts_account; ?></span>
                        	</div>
                               <ul><?php if (!$logged) { ?>
								...
								<?php } ?></li>
								<li><a href="<?php echo $account; ?>" ><span><?php echo $texts_account; ?></span></a></li>
								<li><a href="<?php echo $wishlist; ?>" class="active"><span><?php echo $text_wishlist; ?></span></a></li>
...
<div class="tit"><h3><?php echo $heading; ?></h3></div>
<div class="personal-history">
 <?php if ($products) { ?>								
<div class="history-tit">

<div class="tit h-2"><?php echo $column_name; ?></div>
<div class="tit h-3"><?php echo $column_model; ?></div>
<div class="tit h-4"><?php echo $column_stock; ?></div>
<div class="tit h-5"><?php echo $column_action; ?></div>
</div>
...
<?php } ?></div>
<div class="tit h-2"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
<div class="tit h-3"><?php echo $product['model']; ?></div>
<div class="tit h-4"><?php echo $product['stock']; ?></div>
