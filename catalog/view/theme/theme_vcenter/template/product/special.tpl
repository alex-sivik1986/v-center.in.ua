...
<section id="catalog" class="container-1300"> 
...
<h1><?php echo $heading_title; ?></h1>
	  ...
	  <?php if ($products) { ?>
			...
			<div class="product product-<?=$m?>">
                            <div class="img"><img src="<?php echo $product['thumb']; ?>" alt="" /></div>
                            <div class="info">
                                <a href="<?php echo $product['href']; ?>" class="tit"><?php echo $product['name']; ?></a>
                                <?php echo $product['short_description']; ?>
                                <div class="flex">
								  <?php if($product['attribute'])  { 
                                   $attr1 = next($product['attribute']);   	  ?>								  
                                    <p><?=$attr1['name']?><br/> <?=$attr1['text']?></p>
								  ...
								  <?php  } ?>
                                    <div class="btn-block">
										...
										<button type="button" class="buy-btn" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');">
                                   ...
                                   <?php if($product['attribute'])  { 
                                    ...
                                    $size = next($product['attribute']);       ?>
								  
                                    <p><?=$size['name']?><br/> <?=$size['text']?></p>
