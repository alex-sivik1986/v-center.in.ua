...
class ControllerCatalogProduct extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
        ...
        $data['entry_image_home'] = $this->language->get('entry_image_home');
        ...
        $data['entry_home_text'] = $this->language->get('entry_home_text');
    ...
    $data['manufacturers'] = $this->model_catalog_manufacturer->getManufacturers();
        ...
        if (isset($this->request->post['image_home'])) {
			$data['image_home'] = $this->request->post['image_home'];
		} elseif (!empty($product_info)) {
			$data['image_home'] = $product_info['image_home'];
		} else {
			$data['image_home'] = '';
		}
		$this->load->model('tool/image');
        ...
        if (isset($this->request->post['image_home']) && is_file(DIR_IMAGE . $this->request->post['image_home'])) {
			$data['thumb_home'] = $this->model_tool_image->resize($this->request->post['image_home'], 100, 100);
		} elseif (!empty($product_info) && is_file(DIR_IMAGE . $product_info['image_home'])) {
			$data['thumb_home'] = $this->model_tool_image->resize($product_info['image_home'], 100, 100);
		} else {
