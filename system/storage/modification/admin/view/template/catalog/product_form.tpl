          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				  ...
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-attr<?php echo $language['language_id']; ?>">Заметка между характеристиками</label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][attr]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['attr'] : ''; ?>"  id="input-attr<?php echo $language['language_id']; ?>" class="form-control" />
				  ...
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-short-description<?php echo $language['language_id']; ?>"><?php echo $entry_short_desc; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][short_description]" placeholder="<?php echo $entry_short_desc; ?>" id="input-short-description<?php echo $language['language_id']; ?>" data-lang="<?php echo $lang; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_description'] : ''; ?></textarea>
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description2<?php echo $language['language_id']; ?>"><?php echo $entry_home_text; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][description2]" placeholder="<?php echo $entry_home_text; ?>" id="input-description2<?php echo $language['language_id']; ?>" data-lang="<?php echo $lang; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description2'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
			 <div style="display:none" class="form-group">
                <label class="col-sm-2 control-label" for="input-home"><span data-toggle="tooltip" title=""><?php echo $entry_home; ?></span></label>
                <div class="col-sm-2">
                  <div class="checkbox">
                    <label>
                      <?php if ($home) { ?>
                      <input type="checkbox" name="home" value="1" checked="checked" id="input-home" />
                      <?php } else { ?>
                       <input type="checkbox" name="home" value="0" checked="checked"  id="input-home" />
                      <?php } ?>
                      &nbsp; </label>
			 ...
			 <div style="display:none" class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_image_home; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-image-home" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_home; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="image-home" value="<?php echo $image_home; ?>" id="input-image-home" />
                </div>
              </div>
                  ...
                  <tbody>
                    ...
                    <tr id="attribute-row<?php echo $attribute_row; ?>">
                      <td class="text-left" style="width: 40%;"><input type="text" name="product_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $product_attribute['name']; ?>" placeholder="<?php echo $entry_attribute; ?>" class="form-control" />
						...
						<div class="checkbox">
                      <label>
                        <?php if ($product_attribute['view']==1) { ?>
                        <input type="checkbox" name="product_attribute[<?php echo $attribute_row; ?>][view]" value="1" checked="checked" /> Для вывода данного аттрибута в категории и просмотренных товарах
                       
                        <?php } else { ?>
                        <input type="checkbox" name="product_attribute[<?php echo $attribute_row; ?>][view]" value="1" /> Для вывода данного аттрибута в категории и просмотренных товарах
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]" class="form-control">
                                  ...
                                  <option value="<?php echo $option_value['option_value_id']; ?>" selected="selected"><?php echo !empty($option_value['long_name'])?$option_value['long_name']:$option_value['name']; ?></option>
                                  <?php } else { ?>
                                  <option value="<?php echo $option_value['option_value_id']; ?>"><?php echo !empty($option_value['long_name'])?$option_value['long_name']:$option_value['name']; ?></option>
                                  <?php } ?>
                                  <?php } ?>
                                  <?php } ?>
                                </select>
...
function addAttribute() {
	...
	html += '  <td class="text-left" style="width: 20%;"><input type="text" name="product_attribute[' + attribute_row + '][name]" value="" placeholder="<?php echo $entry_attribute; ?>" class="form-control" /><input type="hidden" name="product_attribute[' + attribute_row + '][attribute_id]" value="" />';
	html += ' <input type="checkbox" name="product_attribute[' + attribute_row + '][view]" value="1" /> Для вывода данного аттрибута в категории и просмотренных товарах</td>';
